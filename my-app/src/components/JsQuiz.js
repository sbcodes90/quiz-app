  ...
  return (
    <>
      <div className=" bg-gradient-to-r from-purple-950 to-purple-800 min-h-screen">
        <header className="fixed top-0 w-full text-2xl text-black font-black text-center p-5 bg-purple-500">
          JS Quiz
        </header>
        <div className="grid lg:grid-cols-2">
          ...
          {!showScore ? (
            <div className="grid-cols-2 mx-20 mb-20 lg:mr-20  lg:mt-[150px]">
            ...
            <div className="text-white font-black text-2xl text-center lg:mt-[120px] lg:mr-10 lg:mb-40 rounded-3xl pt-0 lg:pt-[100px] mb-20 p-10">
              {score === 4 && (
                <>
                  <div className="mb-10 lg:mb-10">Congrats Friend! You scored 100%!</div>
                  <Link
                    to="/options"
